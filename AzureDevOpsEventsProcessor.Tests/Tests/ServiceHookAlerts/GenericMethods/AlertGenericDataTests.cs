...
namespace AzureDevOpsEventsProcessor.Tests.ServiceHookAlerts.GenericMethods
{
    [TestClass]
    public class AlertGenericDataTests
    {
        ...
        {
            // arrange
            var provider = new AzureDevOpsEventsProcessor.Providers.JsonDataProvider(Helpers.ServiceHookTestData.GetEventJson("workitem.updated"));
        ...
        {
            // arrange
            var provider = new AzureDevOpsEventsProcessor.Providers.JsonDataProvider(Helpers.ServiceHookTestData.GetEventJson("git.pullrequest.created"));
