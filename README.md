...
This project replace the my [original Codeplex Repo](https://tfsalertsdsl.codeplex.com) (now moved to [GitHub](https://github.com/rfennell/VSTSServiceHookDsl) as Codeplex is being depricated), which supported the older SOAP based alerts model. If you need to use this older model use this Codeplex project. 
