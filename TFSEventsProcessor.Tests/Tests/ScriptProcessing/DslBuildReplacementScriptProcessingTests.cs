...
namespace TFSEventsProcessor.Tests.Dsl
{
    ...
    public class DslBuildReplacementScriptProcessingTests
    {
        ...
        public void Can_use_Dsl_to_set_build_retension_by_result()
        {
            ...
            Assert.AreEqual("INFO | TFSEventsProcessor.Dsl.DslLibrary | '20150716.2' retension set to 'True' as result was 'succeeded'", memLogger.Logs[3]);
        ...
        public void Can_use_Dsl_to_unset_build_retension_by_quality()
        {
            ...
            // memLogger.Logs[1] is the log message from the runscript method
            // memLogger.Logs[2] is the log message from the runscript method
            Assert.AreEqual("INFO | TFSEventsProcessor.Dsl.DslLibrary | '20150716.2' retension set to 'False' as result was 'failed'", memLogger.Logs[3]);
