...
namespace TFSEventsProcessor.Tests.Dsl
{
    ...
    public class DslScriptingTests
    {
        ...
        public void Can_use_methods_in_two_dsl_libraries_script()
        {
            ...
            Assert.AreEqual("INFO | TFSEventsProcessor.Dsl.DslLibrary | When you add 1 and 2 you get 3", memLogger.Logs[3]);
        ...
        public void Error_logged_if_no_Dsl_library_folder_found()
        {
            ...
            Assert.AreEqual(@"ERROR | TFSEventsProcessor.Dsl.DslProcessor | DslProcessor: DslProcessor cannot find DSL folder c:\dummy", memLogger.Logs[0]);
        ...
        public void Error_logged_if_no_Dsl_library_in_dsl_folder()
        {
            ...
            // memLogger.Logs[0] is the log message from the runscript method
            // memLogger.Logs[1] is the log message from the runscript method
            Assert.IsTrue(memLogger.Logs[2].StartsWith(@"ERROR | TFSEventsProcessor.Dsl.DslProcessor | DslProcessor: DslProcessor cannot find DSL libraries in folder "));
